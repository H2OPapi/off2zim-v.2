      ...
      <div className="container flex flex-col items-center">
        <div className="rb-12 mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <h1 className="mb-5 text-6xl font-bold md:mb-6 md:text-9xl lg:text-10xl">
            Discover Exciting Events Across Zimbabwe
          </h1>
          <p className="md:text-md">
            Explore a vibrant array of events happening throughout Zimbabwe,
            from lively concerts to cultural festivals. Our events booking
            service makes it easy to secure your spot at the most exciting
