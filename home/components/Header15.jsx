        ...
        <div className="rb-12 mb-12 grid grid-cols-1 items-start gap-x-12 gap-y-5 md:mb-18 md:grid-cols-2 md:gap-y-8 lg:mb-20 lg:gap-x-20 lg:gap-y-16">
          ...
          <div>
            <p className="md:text-md">
              Welcome to Off2Zim, your ultimate guide to exploring the beauty
              and adventure of Zimbabwe. From breathtaking landscapes to vibrant
              culture, we are here to enhance your travel experience.
            </p>
